...
public class CharacterDescriptionDrawThread extends Thread{
	CharacterDescriptionView father;				
	SurfaceHolder surfaceHolder;	
	boolean flag;
	int sleepSpan = 100;		
	
	/* Constructor */
	public CharacterDescriptionDrawThread(CharacterDescriptionView father, SurfaceHolder surfaceHolder) {
